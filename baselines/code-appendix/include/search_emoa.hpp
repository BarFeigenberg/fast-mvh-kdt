...
#ifndef EMOAREF_BASIC_SEARCH_EMOA_H_
#define EMOAREF_BASIC_SEARCH_EMOA_H_
...
struct EMOAResult {
  ...
  long n_generated = 0;
  long n_expanded = 0;
  long long n_domCheck = 0; // 64-bit: the dominance-check count exceeds 2^31 at high M
...
public:
  ...
  long vid = -1; // owning vertex id, used for per-vertex op capture.
...
// Flag-gated per-vertex capture of projected dominance ops; no-op unless EMOA_CAPTURE is set.
...
#endif  // EMOAREF_BASIC_SEARCH_DIJKSTRA_H_
