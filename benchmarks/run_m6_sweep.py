...
M6_LOG = "benchmarks/runs/adaptive_explorer/m6_multidim_sweep.log"
...
def log(msg, end="\n"):
    ...
    with open(M6_LOG, "a", encoding="utf-8") as f:
        f.write(msg + end)
...
def run_suite(include_v5=True, timeout=600):
    log("=============================================================")
    log("  TASK 3: HIGH-DIMENSIONAL SCALING (M=6)")
    log("=============================================================")
    
    queue = [
        (8, 6, 0.0, 50), (8, 6, 0.0, 100),
